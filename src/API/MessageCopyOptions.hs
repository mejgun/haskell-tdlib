...
-- 
-- __new_caption__ New message caption. Ignored if replace_caption is false
data MessageCopyOptions = 

 MessageCopyOptions { new_caption :: Maybe FormattedText.FormattedText, replace_caption :: Maybe Bool, send_copy :: Maybe Bool }  deriving (Show, Eq)
