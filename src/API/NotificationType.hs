...
data NotificationType = 
 ...
 NotificationTypeNewPushMessage { content :: Maybe PushMessageContent.PushMessageContent, is_outgoing :: Maybe Bool, sender_name :: Maybe String, sender :: Maybe MessageSender.MessageSender, message_id :: Maybe Int }  deriving (Show, Eq)
