...
data VectorPathCommand = 
 ...
 VectorPathCommandCubicBezierCurve { end_point :: Maybe Point.Point, end_control_point :: Maybe Point.Point, start_control_point :: Maybe Point.Point }  deriving (Show, Eq)
