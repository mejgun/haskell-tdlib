...
-- 
-- __invite_link_changes__ True, if changes to invite links should be returned
-- 
-- __voice_chat_changes__ True, if voice chat actions should be returned
data ChatEventLogFilters = 

 ChatEventLogFilters { voice_chat_changes :: Maybe Bool, invite_link_changes :: Maybe Bool, setting_changes :: Maybe Bool, info_changes :: Maybe Bool, member_restrictions :: Maybe Bool, member_promotions :: Maybe Bool, member_invites :: Maybe Bool, member_leaves :: Maybe Bool, member_joins :: Maybe Bool, message_pins :: Maybe Bool, message_deletions :: Maybe Bool, message_edits :: Maybe Bool }  deriving (Show, Eq)
