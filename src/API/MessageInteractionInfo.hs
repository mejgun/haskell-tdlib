...
data MessageInteractionInfo = 
 ...
 MessageInteractionInfo { reply_info :: Maybe MessageReplyInfo.MessageReplyInfo, forward_count :: Maybe Int, view_count :: Maybe Int }  deriving (Eq)

instance Show MessageInteractionInfo where
 show MessageInteractionInfo { reply_info=reply_info, forward_count=forward_count, view_count=view_count } =
  "MessageInteractionInfo" ++ cc [p "reply_info" reply_info, p "forward_count" forward_count, p "view_count" view_count ]
