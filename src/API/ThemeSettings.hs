...
data ThemeSettings = 
 ...
 ThemeSettings { outgoing_message_accent_color :: Maybe Int, animate_outgoing_message_fill :: Maybe Bool, outgoing_message_fill :: Maybe BackgroundFill.BackgroundFill, background :: Maybe Background.Background, accent_color :: Maybe Int }  deriving (Show, Eq)
