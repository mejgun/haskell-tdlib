...
data ChatStatisticsAdministratorActionsInfo = 
 ...
 ChatStatisticsAdministratorActionsInfo { restricted_user_count :: Maybe Int, banned_user_count :: Maybe Int, deleted_message_count :: Maybe Int, user_id :: Maybe Int }  deriving (Show, Eq)
