...
instance Show Chat where
 show Chat { client_data=client_data, draft_message=draft_message, reply_markup_message_id=reply_markup_message_id, pending_join_requests=pending_join_requests, video_chat=video_chat, action_bar=action_bar, theme_name=theme_name, message_ttl=message_ttl, available_reactions=available_reactions, notification_settings=notification_settings, unread_reaction_count=unread_reaction_count, unread_mention_count=unread_mention_count, last_read_outbox_message_id=last_read_outbox_message_id, last_read_inbox_message_id=last_read_inbox_message_id, unread_count=unread_count, default_disable_notification=default_disable_notification, can_be_reported=can_be_reported, can_be_deleted_for_all_users=can_be_deleted_for_all_users, can_be_deleted_only_for_self=can_be_deleted_only_for_self, has_scheduled_messages=has_scheduled_messages, is_blocked=is_blocked, is_marked_as_unread=is_marked_as_unread, has_protected_content=has_protected_content, message_sender_id=message_sender_id, positions=positions, last_message=last_message, permissions=permissions, photo=photo, title=title, _type=_type, _id=_id } =
  "Chat" ++ U.cc [U.p "client_data" client_data, U.p "draft_message" draft_message, U.p "reply_markup_message_id" reply_markup_message_id, U.p "pending_join_requests" pending_join_requests, U.p "video_chat" video_chat, U.p "action_bar" action_bar, U.p "theme_name" theme_name, U.p "message_ttl" message_ttl, U.p "available_reactions" available_reactions, U.p "notification_settings" notification_settings, U.p "unread_reaction_count" unread_reaction_count, U.p "unread_mention_count" unread_mention_count, U.p "last_read_outbox_message_id" last_read_outbox_message_id, U.p "last_read_inbox_message_id" last_read_inbox_message_id, U.p "unread_count" unread_count, U.p "default_disable_notification" default_disable_notification, U.p "can_be_reported" can_be_reported, U.p "can_be_deleted_for_all_users" can_be_deleted_for_all_users, U.p "can_be_deleted_only_for_self" can_be_deleted_only_for_self, U.p "has_scheduled_messages" has_scheduled_messages, U.p "is_blocked" is_blocked, U.p "is_marked_as_unread" is_marked_as_unread, U.p "has_protected_content" has_protected_content, U.p "message_sender_id" message_sender_id, U.p "positions" positions, U.p "last_message" last_message, U.p "permissions" permissions, U.p "photo" photo, U.p "title" title, U.p "_type" _type, U.p "_id" _id ]
