...
data MessageForwardInfo = 
 ...
 MessageForwardInfo { from_message_id :: Maybe Int, from_chat_id :: Maybe Int, public_service_announcement_type :: Maybe String, date :: Maybe Int, origin :: Maybe MessageForwardOrigin.MessageForwardOrigin }  deriving (Eq)
