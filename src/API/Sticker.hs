...
data Sticker = 
 ...
 Sticker { sticker :: Maybe File.File, thumbnail :: Maybe Thumbnail.Thumbnail, outline :: Maybe [ClosedVectorPath.ClosedVectorPath], mask_position :: Maybe MaskPosition.MaskPosition, is_mask :: Maybe Bool, is_animated :: Maybe Bool, emoji :: Maybe String, height :: Maybe Int, width :: Maybe Int, set_id :: Maybe Int }  deriving (Show, Eq)
