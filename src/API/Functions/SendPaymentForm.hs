...
data SendPaymentForm = 
 ...
 SendPaymentForm { tip_amount :: Maybe Int, credentials :: Maybe InputCredentials.InputCredentials, shipping_option_id :: Maybe String, order_info_id :: Maybe String, payment_form_id :: Maybe Int, message_id :: Maybe Int, chat_id :: Maybe Int }  deriving (Show, Eq)
