...
-- 
-- __filter__ Filter for message content in the search results; searchMessagesFilterCall, searchMessagesFilterMissedCall, searchMessagesFilterMention, searchMessagesFilterUnreadMention, searchMessagesFilterFailedToSend and searchMessagesFilterPinned are unsupported in this function
-- 
...
data SearchMessages = 
 ...
 SearchMessages { max_date :: Maybe Int, min_date :: Maybe Int, _filter :: Maybe SearchMessagesFilter.SearchMessagesFilter, limit :: Maybe Int, offset_message_id :: Maybe Int, offset_chat_id :: Maybe Int, offset_date :: Maybe Int, query :: Maybe String, chat_list :: Maybe ChatList.ChatList }  deriving (Show, Eq)
