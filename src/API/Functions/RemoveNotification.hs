...
-- 
-- __notification_group_id__ Identifier of notification group to which the notification belongs
-- 
...
instance Show RemoveNotification where
 show RemoveNotification { notification_id=notification_id, notification_group_id=notification_group_id } =
  "RemoveNotification" ++ U.cc [U.p "notification_id" notification_id, U.p "notification_group_id" notification_group_id ]
