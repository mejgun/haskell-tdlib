...
-- 
-- __sender__ The sender sender of the message
-- 
...
data AddLocalMessage = 
 ...
 AddLocalMessage { input_message_content :: Maybe InputMessageContent.InputMessageContent, disable_notification :: Maybe Bool, reply_to_message_id :: Maybe Int, sender :: Maybe MessageSender.MessageSender, chat_id :: Maybe Int }  deriving (Show, Eq)
