...
data CreateNewSupergroupChat = 
 ...
 CreateNewSupergroupChat { for_import :: Maybe Bool, location :: Maybe ChatLocation.ChatLocation, description :: Maybe String, is_channel :: Maybe Bool, title :: Maybe String }  deriving (Show, Eq)
