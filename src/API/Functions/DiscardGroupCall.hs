...
data DiscardGroupCall = 
 ...
 DiscardGroupCall { group_call_id :: Maybe Int }  deriving (Eq)

instance Show DiscardGroupCall where
 show DiscardGroupCall { group_call_id=group_call_id } =
  "DiscardGroupCall" ++ cc [p "group_call_id" group_call_id ]
