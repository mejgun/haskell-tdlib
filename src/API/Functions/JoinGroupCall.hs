...
-- 
-- __participant_id__ Identifier of a group call participant, which will be used to join the call; voice chats only
-- 
...
data JoinGroupCall = 
 ...
 JoinGroupCall { invite_hash :: Maybe String, is_my_video_enabled :: Maybe Bool, is_muted :: Maybe Bool, payload :: Maybe String, audio_source_id :: Maybe Int, participant_id :: Maybe MessageSender.MessageSender, group_call_id :: Maybe Int }  deriving (Show, Eq)
