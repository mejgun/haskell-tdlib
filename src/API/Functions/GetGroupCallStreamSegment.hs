...
-- 
-- __video_quality__ Video quality as received from tgcalls; pass null to get the worst available quality
data GetGroupCallStreamSegment = 

 GetGroupCallStreamSegment { video_quality :: Maybe GroupCallVideoQuality.GroupCallVideoQuality, channel_id :: Maybe Int, scale :: Maybe Int, time_offset :: Maybe Int, group_call_id :: Maybe Int }  deriving (Eq)

instance Show GetGroupCallStreamSegment where
 show GetGroupCallStreamSegment { video_quality=video_quality, channel_id=channel_id, scale=scale, time_offset=time_offset, group_call_id=group_call_id } =
  "GetGroupCallStreamSegment" ++ U.cc [U.p "video_quality" video_quality, U.p "channel_id" channel_id, U.p "scale" scale, U.p "time_offset" time_offset, U.p "group_call_id" group_call_id ]
