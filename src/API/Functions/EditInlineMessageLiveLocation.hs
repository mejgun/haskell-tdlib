...
data EditInlineMessageLiveLocation = 
 ...
 EditInlineMessageLiveLocation { proximity_alert_radius :: Maybe Int, heading :: Maybe Int, location :: Maybe Location.Location, reply_markup :: Maybe ReplyMarkup.ReplyMarkup, inline_message_id :: Maybe String }  deriving (Eq)
