...
data GetLoginUrlInfo = 
 ...
 GetLoginUrlInfo { button_id :: Maybe Int, message_id :: Maybe Int, chat_id :: Maybe Int }  deriving (Eq)

instance Show GetLoginUrlInfo where
 show GetLoginUrlInfo { button_id=button_id, message_id=message_id, chat_id=chat_id } =
  "GetLoginUrlInfo" ++ U.cc [U.p "button_id" button_id, U.p "message_id" message_id, U.p "chat_id" chat_id ]
