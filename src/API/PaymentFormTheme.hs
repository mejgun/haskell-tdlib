...
data PaymentFormTheme = 
 ...
 PaymentFormTheme { button_text_color :: Maybe Int, button_color :: Maybe Int, link_color :: Maybe Int, hint_color :: Maybe Int, text_color :: Maybe Int, background_color :: Maybe Int }  deriving (Show, Eq)
