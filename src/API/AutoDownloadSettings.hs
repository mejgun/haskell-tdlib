...
-- autoDownloadSettings AutoDownloadSettings  { use_less_data_for_calls :: Bool, preload_next_audio :: Bool, preload_large_videos :: Bool, video_upload_bitrate :: Int, max_other_file_size :: Int, max_video_file_size :: Int, max_photo_file_size :: Int, is_auto_download_enabled :: Bool } 
