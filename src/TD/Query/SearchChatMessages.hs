...
data SearchChatMessages
  = SearchChatMessages
    ...
    , saved_messages_topic :: Maybe SavedMessagesTopic.SavedMessagesTopic     -- ^ If not null, only messages in the specified Saved Messages topic will be returned; pass null to return all messages, or for chats other than Saved Messages
    }
  deriving (Eq, Show)
