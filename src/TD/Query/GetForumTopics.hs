...
-- | Returns found forum topics in a forum supergroup chat or a chat with a bot with topics. This is a temporary method for getting information about topic list from the server. Returns 'TD.Data.ForumTopics.ForumTopics'
data GetForumTopics
  = GetForumTopics
    ...
    , offset_forum_topic_id :: Maybe Int    -- ^ The forum topic identifier of the last found topic, or 0 for the first request
...
instance I.ShortShow GetForumTopics where
  shortShow
    GetForumTopics
      ...
      , offset_forum_topic_id = offset_forum_topic_id_
      , limit                 = limit_
      }
        = "GetForumTopics"
          ++ I.cc
          ...
          , "offset_forum_topic_id" `I.p` offset_forum_topic_id_
          , "limit"                 `I.p` limit_
          ]
    ...
    GetForumTopics
      ...
      , limit                 = limit_
        ...
        = A.object
          ...
          , "offset_forum_topic_id" A..= offset_forum_topic_id_
          , "limit"                 A..= limit_
          ]
