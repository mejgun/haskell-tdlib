...
-- | Returns an invoice payment form. This method must be called when the user presses inline button of the type inlineKeyboardButtonTypeBuy. Returns 'TD.Data.PaymentForm.PaymentForm'
data GetPaymentForm
  = GetPaymentForm
