...
-- | Returns up to 8 emoji statuses, which must be shown right after the default Premium Badge in the emoji status list for self status. Returns 'TD.Data.EmojiStatusCustomEmojis.EmojiStatusCustomEmojis'
