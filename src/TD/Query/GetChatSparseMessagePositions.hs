...
data GetChatSparseMessagePositions
  = GetChatSparseMessagePositions
    ...
    , saved_messages_topic :: Maybe SavedMessagesTopic.SavedMessagesTopic     -- ^ If not null, only messages in the specified Saved Messages topic will be considered; pass null to consider all messages, or for chats other than Saved Messages
    }
  deriving (Eq, Show)
