...
data GetReceivedGifts
  = GetReceivedGifts
    ...
    , exclude_without_colors :: Maybe Bool                        -- ^ Pass true to exclude gifts that can't be used in setUpgradedGiftColors
    , exclude_hosted         :: Maybe Bool                        -- ^ Pass true to exclude gifts that are just hosted and are not owned by the owner
...
instance I.ShortShow GetReceivedGifts where
  shortShow
    GetReceivedGifts
      ...
      , exclude_without_colors = exclude_without_colors_
      , exclude_hosted         = exclude_hosted_
      ...
      , limit                  = limit_
        ...
        = "GetReceivedGifts"
          ...
          , "exclude_without_colors" `I.p` exclude_without_colors_
          , "exclude_hosted"         `I.p` exclude_hosted_
    ...
    GetReceivedGifts
      ...
      , limit                  = limit_
        ...
        = A.object
          ...
          , "exclude_without_colors" A..= exclude_without_colors_
          , "exclude_hosted"         A..= exclude_hosted_
...
defaultGetReceivedGifts =
  GetReceivedGifts
    ...
    , exclude_without_colors = Nothing
    , exclude_hosted         = Nothing
