...
-- | Returns an affiliate program that was connected to the given affiliate by identifier of the bot that created the program. Returns 'TD.Data.ConnectedAffiliateProgram.ConnectedAffiliateProgram'
