...
-- | Returns list of boosts applied to a chat by a given user; requires administrator rights in the channel chat; for bots only. Returns 'TD.Data.FoundChatBoosts.FoundChatBoosts'
