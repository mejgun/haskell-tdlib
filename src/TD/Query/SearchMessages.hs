...
import qualified TD.Data.SearchMessagesChatTypeFilter as SearchMessagesChatTypeFilter
...
data SearchMessages
  = SearchMessages
    ...
    , _filter          :: Maybe SearchMessagesFilter.SearchMessagesFilter                 -- ^ Additional filter for messages to search; pass null to search for all messages. Filters searchMessagesFilterMention, searchMessagesFilterUnreadMention, searchMessagesFilterUnreadReaction, searchMessagesFilterUnreadPollVote, searchMessagesFilterFailedToSend, and searchMessagesFilterPinned are unsupported in this function
    , chat_type_filter :: Maybe SearchMessagesChatTypeFilter.SearchMessagesChatTypeFilter -- ^ Additional filter for type of the chat of the searched messages; pass null to search for messages in all chats
...
instance I.ShortShow SearchMessages where
  shortShow
    SearchMessages
      ...
      , limit            = limit_
      , _filter          = _filter_
      , chat_type_filter = chat_type_filter_
      , min_date         = min_date_
      , max_date         = max_date_
      }
        = "SearchMessages"
          ...
          , "chat_type_filter" `I.p` chat_type_filter_
    ...
    SearchMessages
      ...
      , max_date         = max_date_
        ...
        = A.object
          ...
          , "limit"            A..= limit_
          , "filter"           A..= _filter_
          , "chat_type_filter" A..= chat_type_filter_
