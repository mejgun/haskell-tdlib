...
-- | Returns information about a basic group by its identifier. This is an offline method if the current user is not a bot. Returns 'TD.Data.BasicGroup.BasicGroup'
data GetBasicGroup
  = GetBasicGroup
