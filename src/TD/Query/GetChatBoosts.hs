...
-- | Returns list of boosts applied to a chat. The user must be an administrator in the channel chat to get the list of boosts. Returns 'TD.Data.FoundChatBoosts.FoundChatBoosts'
data GetChatBoosts
  = GetChatBoosts
