...
-- | Returns list of revenue transactions for a chat. Currently, this method can be used only for channels if supergroupFullInfo.can_get_revenue_statistics == true. Returns 'TD.Data.ChatRevenueTransactions.ChatRevenueTransactions'
