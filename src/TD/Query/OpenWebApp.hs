...
data OpenWebApp
  = OpenWebApp
    ...
    , message_thread_id             :: Maybe Int                                       -- ^ If not 0, the message thread identifier to which the message will be sent
    , direct_messages_chat_topic_id :: Maybe Int                                       -- ^ If not 0, unique identifier of the topic of channel direct messages chat to which the message will be sent
