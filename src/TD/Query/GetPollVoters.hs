...
-- | Returns message senders voted for the specified option in a non-anonymous polls. For optimal performance, the number of returned users is chosen by TDLib. Returns 'TD.Data.PollVoters.PollVoters'
data GetPollVoters
  = GetPollVoters
