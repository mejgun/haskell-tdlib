...
-- | Returns message senders voted for the specified option in a poll; use poll.can_get_voters to check whether the method can be used. For optimal performance, the number of returned users is chosen by TDLib. Returns 'TD.Data.PollVoters.PollVoters'
data GetPollVoters
  = GetPollVoters
