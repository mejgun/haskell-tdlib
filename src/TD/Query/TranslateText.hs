...
-- | Translates a text to the given language; must not be used in secret chats. If the current user is a Telegram Premium user, then text formatting is preserved. Returns 'TD.Data.FormattedText.FormattedText'
data TranslateText
  = TranslateText
    ...
    , tone             :: Maybe T.Text                      -- ^ Tone of the translation; must be one of "", "formal", "neutral", "casual"; defaults to "neutral"
    }
  deriving (Eq, Show)
