...
data GetChatMessageCount
  = GetChatMessageCount
    ...
    , saved_messages_topic :: Maybe SavedMessagesTopic.SavedMessagesTopic     -- ^ If not null, only messages in the specified Saved Messages topic will be counted; pass null to count all messages, or for chats other than Saved Messages
