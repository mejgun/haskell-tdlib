...
data MessageSendingState
  ...
  | MessageSendingStateFailed -- ^ The message failed to be sent
    ...
    , required_paid_message_star_count :: Maybe Int         -- ^ The number of Telegram Stars that must be paid to send the message; 0 if the current amount is correct
...
instance I.ShortShow MessageSendingState where
  ...
  shortShow MessageSendingStateFailed
    ...
    , required_paid_message_star_count = required_paid_message_star_count_
    , retry_after                      = retry_after_
      ...
      = "MessageSendingStateFailed"
        ...
        , "required_paid_message_star_count" `I.p` required_paid_message_star_count_
  ...
  parseJSON v@(AT.Object obj) = do
    ...
    where
      ...
      parseMessageSendingStateFailed = A.withObject "MessageSendingStateFailed" $ \o -> do
        ...
        required_paid_message_star_count_ <- o A..:?  "required_paid_message_star_count"
