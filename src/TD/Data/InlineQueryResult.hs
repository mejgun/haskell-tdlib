...
instance AT.ToJSON InlineQueryResult where
  toJSON InlineQueryResultArticle
    ...
    , thumbnail   = thumbnail_
      ...
      = A.object
        [ "@type"       A..= AT.String "inlineQueryResultArticle"
        , "id"          A..= _id_
        , "url"         A..= url_
  ...
  toJSON InlineQueryResultContact
    ...
    , thumbnail = thumbnail_
      ...
      = A.object
        [ "@type"     A..= AT.String "inlineQueryResultContact"
        , "id"        A..= _id_
        , "contact"   A..= contact_
        , "thumbnail" A..= thumbnail_
        ]
  toJSON InlineQueryResultLocation
    ...
    , thumbnail = thumbnail_
      ...
      = A.object
        [ "@type"     A..= AT.String "inlineQueryResultLocation"
        , "id"        A..= _id_
  ...
  toJSON InlineQueryResultVenue
    ...
    , thumbnail = thumbnail_
      ...
      = A.object
        [ "@type"     A..= AT.String "inlineQueryResultVenue"
        , "id"        A..= _id_
        , "venue"     A..= venue_
        , "thumbnail" A..= thumbnail_
        ]
  toJSON InlineQueryResultGame
    { _id  = _id_
    , game = game_
    }
      = A.object
        [ "@type" A..= AT.String "inlineQueryResultGame"
        , "id"    A..= _id_
        , "game"  A..= game_
        ]
  toJSON InlineQueryResultAnimation
    { _id       = _id_
    , animation = animation_
    , title     = title_
    }
      = A.object
        [ "@type"     A..= AT.String "inlineQueryResultAnimation"
        , "id"        A..= _id_
  ...
  toJSON InlineQueryResultAudio
    ...
    , audio = audio_
      ...
      = A.object
        [ "@type" A..= AT.String "inlineQueryResultAudio"
        , "id"    A..= _id_
        , "audio" A..= audio_
        ]
  toJSON InlineQueryResultDocument
    ...
    , description = description_
      ...
      = A.object
        [ "@type"       A..= AT.String "inlineQueryResultDocument"
        , "id"          A..= _id_
  ...
  toJSON InlineQueryResultPhoto
    ...
    , description = description_
      ...
      = A.object
        [ "@type"       A..= AT.String "inlineQueryResultPhoto"
        , "id"          A..= _id_
        , "photo"       A..= photo_
        , "title"       A..= title_
        , "description" A..= description_
        ]
  toJSON InlineQueryResultSticker
    { _id     = _id_
    , sticker = sticker_
    }
      = A.object
        [ "@type"   A..= AT.String "inlineQueryResultSticker"
        , "id"      A..= _id_
        , "sticker" A..= sticker_
        ]
  toJSON InlineQueryResultVideo
    ...
    , description = description_
      ...
      = A.object
        [ "@type"       A..= AT.String "inlineQueryResultVideo"
        , "id"          A..= _id_
        , "video"       A..= video_
        , "title"       A..= title_
        , "description" A..= description_
        ]
  toJSON InlineQueryResultVoiceNote
    { _id        = _id_
    , voice_note = voice_note_
    , title      = title_
    }
      = A.object
        [ "@type"      A..= AT.String "inlineQueryResultVoiceNote"
        , "id"         A..= _id_
