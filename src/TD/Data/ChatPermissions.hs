...
data ChatPermissions
  = ChatPermissions -- ^ Describes actions that a user is allowed to take in a chat
    ...
    , can_add_web_page_previews :: Maybe Bool -- ^ True, if the user may add a web page preview to their messages
  ...
  shortShow ChatPermissions
    ...
    , can_manage_topics         = can_manage_topics_
      ...
      = "ChatPermissions"
        ...
        , "can_add_web_page_previews" `I.p` can_add_web_page_previews_
