...
data ChatPermissions
  = ChatPermissions -- ^ Describes actions that a user is allowed to take in a chat
    ...
    , can_react_to_messages   :: Maybe Bool -- ^ True, if the user can react to messages
...
instance I.ShortShow ChatPermissions where
  shortShow ChatPermissions
    ...
    , can_react_to_messages   = can_react_to_messages_
    ...
    , can_create_topics       = can_create_topics_
      ...
      = "ChatPermissions"
        ...
        , "can_react_to_messages"   `I.p` can_react_to_messages_
  ...
  parseJSON v@(AT.Object obj) = do
    ...
    where
      ...
      parseChatPermissions = A.withObject "ChatPermissions" $ \o -> do
        ...
        can_react_to_messages_   <- o A..:?  "can_react_to_messages"
  ...
  toJSON ChatPermissions
    ...
    , can_create_topics       = can_create_topics_
      ...
      = A.object
        ...
        , "can_react_to_messages"   A..= can_react_to_messages_
