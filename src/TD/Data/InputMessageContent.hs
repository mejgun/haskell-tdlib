module TD.Data.InputMessageContent
  ( InputMessageContent(..)      
  , defaultInputMessageText      
  , defaultInputMessageAnimation 
  , defaultInputMessageAudio     
  , defaultInputMessageDocument  
  , defaultInputMessagePhoto     
  , defaultInputMessageSticker   
  , defaultInputMessageVideo     
  , defaultInputMessageVideoNote 
  , defaultInputMessageVoiceNote 
  , defaultInputMessageLocation  
  , defaultInputMessageVenue     
  , defaultInputMessageContact   
  , defaultInputMessageDice      
  , defaultInputMessageGame      
  , defaultInputMessageInvoice   
  , defaultInputMessagePoll      
  , defaultInputMessageStory     
  , defaultInputMessageForwarded 
  ) where
...
data InputMessageContent
  ...
  | InputMessageDocument -- ^ A document message (general file)
    ...
    , disable_content_type_detection :: Maybe Bool                          -- ^ If true, automatic file type detection will be disabled and the document will always be sent as file. Always true for files sent to secret chats
...
defaultInputMessageText :: InputMessageContent
defaultInputMessageText =
  InputMessageText
    { text                     = Nothing
...
defaultInputMessageAnimation :: InputMessageContent
defaultInputMessageAnimation =
  InputMessageAnimation
    { animation              = Nothing
    , thumbnail              = Nothing
...
defaultInputMessageAudio :: InputMessageContent
defaultInputMessageAudio =
  InputMessageAudio
    { audio                 = Nothing
...
defaultInputMessageDocument :: InputMessageContent
defaultInputMessageDocument =
  InputMessageDocument
    { document                       = Nothing
    , thumbnail                      = Nothing
...
defaultInputMessagePhoto :: InputMessageContent
defaultInputMessagePhoto =
  InputMessagePhoto
    { photo                  = Nothing
    , thumbnail              = Nothing
...
defaultInputMessageSticker :: InputMessageContent
defaultInputMessageSticker =
  InputMessageSticker
    { sticker   = Nothing
    , thumbnail = Nothing
...
defaultInputMessageVideo :: InputMessageContent
defaultInputMessageVideo =
  InputMessageVideo
    { video                  = Nothing
    , thumbnail              = Nothing
...
defaultInputMessageVideoNote :: InputMessageContent
defaultInputMessageVideoNote =
  InputMessageVideoNote
    { video_note = Nothing
    , thumbnail  = Nothing
...
defaultInputMessageVoiceNote :: InputMessageContent
defaultInputMessageVoiceNote =
  InputMessageVoiceNote
    { voice_note = Nothing
    , duration   = Nothing
...
defaultInputMessageLocation :: InputMessageContent
defaultInputMessageLocation =
  InputMessageLocation
    { location               = Nothing
    , live_period            = Nothing
...
defaultInputMessageVenue :: InputMessageContent
defaultInputMessageVenue =
  InputMessageVenue
    { venue = Nothing
    }

defaultInputMessageContact :: InputMessageContent
defaultInputMessageContact =
  InputMessageContact
    { contact = Nothing
    }

defaultInputMessageDice :: InputMessageContent
defaultInputMessageDice =
  InputMessageDice
    { emoji       = Nothing
    , clear_draft = Nothing
...
defaultInputMessageGame :: InputMessageContent
defaultInputMessageGame =
  InputMessageGame
    { bot_user_id     = Nothing
...
defaultInputMessageInvoice :: InputMessageContent
defaultInputMessageInvoice =
  InputMessageInvoice
    { invoice                = Nothing
    , title                  = Nothing
    ...
    , extended_media_content = Nothing
    }

defaultInputMessagePoll :: InputMessageContent
defaultInputMessagePoll =
  InputMessagePoll
    { question     = Nothing
    , options      = Nothing
...
defaultInputMessageStory :: InputMessageContent
defaultInputMessageStory =
  InputMessageStory
...
defaultInputMessageForwarded :: InputMessageContent
defaultInputMessageForwarded =
  InputMessageForwarded
    { from_chat_id  = Nothing
    , message_id    = Nothing
    , in_game_share = Nothing
    , copy_options  = Nothing
    }
