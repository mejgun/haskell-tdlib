...
instance I.ShortShow BotInfo where
  shortShow BotInfo
    ...
    , verification_parameters              = verification_parameters_
    ...
    , edit_settings_link                   = edit_settings_link_
      ...
      = "BotInfo"
        ...
        , "verification_parameters"              `I.p` verification_parameters_
  ...
  parseJSON v@(AT.Object obj) = do
    ...
    where
      ...
      parseBotInfo = A.withObject "BotInfo" $ \o -> do
        ...
        verification_parameters_              <- o A..:?  "verification_parameters"
