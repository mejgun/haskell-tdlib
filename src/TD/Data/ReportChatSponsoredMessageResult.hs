...
import qualified TD.Data.ReportChatSponsoredMessageOption as ReportChatSponsoredMessageOption
...
data ReportChatSponsoredMessageResult
  ...
  | ReportChatSponsoredMessageResultOptionRequired -- ^ The user must choose an option to report the message and repeat request with the chosen option
    ...
    , options :: Maybe [ReportChatSponsoredMessageOption.ReportChatSponsoredMessageOption] -- ^ List of available options
    }
