      ...
      "ChatAdministratorRights"
        ++ U.cc
          [ U.p "is_anonymous" is_anonymous_,
            U.p "can_delete_stories" can_delete_stories_,
            U.p "can_edit_stories" can_edit_stories_,
            U.p "can_post_stories" can_post_stories_,
  ...
  parseJSON v@(T.Object obj) = do
    ...
    where
      ...
      parseChatAdministratorRights = A.withObject "ChatAdministratorRights" $ \o -> do
        ...
        return $ ChatAdministratorRights {is_anonymous = is_anonymous_, can_delete_stories = can_delete_stories_, can_edit_stories = can_edit_stories_, can_post_stories = can_post_stories_, can_manage_video_chats = can_manage_video_chats_, can_promote_members = can_promote_members_, can_manage_topics = can_manage_topics_, can_pin_messages = can_pin_messages_, can_restrict_members = can_restrict_members_, can_invite_users = can_invite_users_, can_delete_messages = can_delete_messages_, can_edit_messages = can_edit_messages_, can_post_messages = can_post_messages_, can_change_info = can_change_info_, can_manage_chat = can_manage_chat_}
  parseJSON _ = mempty
