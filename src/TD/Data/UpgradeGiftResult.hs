...
data UpgradeGiftResult
  = UpgradeGiftResult -- ^ Contains result of gift upgrading
    ...
    , drop_original_details_star_count :: Maybe Int                       -- ^ Number of Telegram Stars that must be paid to drop original details of the upgraded gift; 0 if not available
