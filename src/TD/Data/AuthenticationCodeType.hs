...
instance AT.ToJSON AuthenticationCodeType where
  toJSON AuthenticationCodeTypeTelegramMessage
    { _length = _length_
      ...
      = A.object
        [ "@type"  A..= AT.String "authenticationCodeTypeTelegramMessage"
        , "length" A..= _length_
        ]
  toJSON AuthenticationCodeTypeSms
    { _length = _length_
    }
      = A.object
        [ "@type"  A..= AT.String "authenticationCodeTypeSms"
        , "length" A..= _length_
        ]
  toJSON AuthenticationCodeTypeCall
    { _length = _length_
    }
      = A.object
        [ "@type"  A..= AT.String "authenticationCodeTypeCall"
        , "length" A..= _length_
        ]
  toJSON AuthenticationCodeTypeFlashCall
    { pattern = pattern_
    }
      = A.object
        [ "@type"   A..= AT.String "authenticationCodeTypeFlashCall"
        , "pattern" A..= pattern_
        ]
  toJSON AuthenticationCodeTypeMissedCall
    { phone_number_prefix = phone_number_prefix_
    , _length             = _length_
    }
      = A.object
        [ "@type"               A..= AT.String "authenticationCodeTypeMissedCall"
        , "phone_number_prefix" A..= phone_number_prefix_
        , "length"              A..= _length_
        ]
  toJSON AuthenticationCodeTypeFragment
    { url     = url_
    , _length = _length_
    }
      = A.object
        [ "@type"  A..= AT.String "authenticationCodeTypeFragment"
        , "url"    A..= url_
        , "length" A..= _length_
        ]
  toJSON AuthenticationCodeTypeFirebaseAndroid
    { nonce   = nonce_
    , _length = _length_
    }
      = A.object
  ...
  toJSON AuthenticationCodeTypeFirebaseIos
    ...
    , _length      = _length_
      ...
      = A.object
        [ "@type"        A..= AT.String "authenticationCodeTypeFirebaseIos"
        , "receipt"      A..= receipt_
