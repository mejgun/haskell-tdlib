module TD.Data.InternalLinkType
  ( InternalLinkType(..)                           
  , defaultInternalLinkTypeAttachmentMenuBot       
  , defaultInternalLinkTypeAuthenticationCode      
  , defaultInternalLinkTypeBackground              
  , defaultInternalLinkTypeBotAddToChannel         
  , defaultInternalLinkTypeBotStart                
  , defaultInternalLinkTypeBotStartInGroup         
  , defaultInternalLinkTypeChatFolderInvite        
  , defaultInternalLinkTypeChatInvite              
  , defaultInternalLinkTypeGame                    
  , defaultInternalLinkTypeInstantView             
  , defaultInternalLinkTypeInvoice                 
  , defaultInternalLinkTypeLanguagePack            
  , defaultInternalLinkTypeMessage                 
  , defaultInternalLinkTypeMessageDraft            
  , defaultInternalLinkTypePassportDataRequest     
  , defaultInternalLinkTypePhoneNumberConfirmation 
  , defaultInternalLinkTypePremiumFeatures         
  , defaultInternalLinkTypeProxy                   
  , defaultInternalLinkTypePublicChat              
  , defaultInternalLinkTypeStickerSet              
  , defaultInternalLinkTypeStory                   
  , defaultInternalLinkTypeTheme                   
  , defaultInternalLinkTypeUnknownDeepLink         
  , defaultInternalLinkTypeUserPhoneNumber         
  , defaultInternalLinkTypeUserToken               
  , defaultInternalLinkTypeVideoChat               
  , defaultInternalLinkTypeWebApp                  
  ) where
...
data InternalLinkType -- ^ Describes an internal https://t.me or tg: link, which must be processed by the application in a special way
...
defaultInternalLinkTypeAttachmentMenuBot :: InternalLinkType
defaultInternalLinkTypeAttachmentMenuBot =
  InternalLinkTypeAttachmentMenuBot
    { target_chat  = Nothing
...
defaultInternalLinkTypeAuthenticationCode :: InternalLinkType
defaultInternalLinkTypeAuthenticationCode =
  InternalLinkTypeAuthenticationCode
    { code = Nothing
    }

defaultInternalLinkTypeBackground :: InternalLinkType
defaultInternalLinkTypeBackground =
  InternalLinkTypeBackground
    { background_name = Nothing
    }

defaultInternalLinkTypeBotAddToChannel :: InternalLinkType
defaultInternalLinkTypeBotAddToChannel =
  InternalLinkTypeBotAddToChannel
    { bot_username         = Nothing
    , administrator_rights = Nothing
    }

defaultInternalLinkTypeBotStart :: InternalLinkType
defaultInternalLinkTypeBotStart =
  InternalLinkTypeBotStart
    { bot_username    = Nothing
...
defaultInternalLinkTypeBotStartInGroup :: InternalLinkType
defaultInternalLinkTypeBotStartInGroup =
  InternalLinkTypeBotStartInGroup
    { bot_username         = Nothing
    , start_parameter      = Nothing
...
defaultInternalLinkTypeChatFolderInvite :: InternalLinkType
defaultInternalLinkTypeChatFolderInvite =
  InternalLinkTypeChatFolderInvite
    { invite_link = Nothing
    }

defaultInternalLinkTypeChatInvite :: InternalLinkType
defaultInternalLinkTypeChatInvite =
  InternalLinkTypeChatInvite
    { invite_link = Nothing
    }

defaultInternalLinkTypeGame :: InternalLinkType
defaultInternalLinkTypeGame =
  InternalLinkTypeGame
    { bot_username    = Nothing
...
defaultInternalLinkTypeInstantView :: InternalLinkType
defaultInternalLinkTypeInstantView =
  InternalLinkTypeInstantView
    { url          = Nothing
...
defaultInternalLinkTypeInvoice :: InternalLinkType
defaultInternalLinkTypeInvoice =
  InternalLinkTypeInvoice
    { invoice_name = Nothing
    }

defaultInternalLinkTypeLanguagePack :: InternalLinkType
defaultInternalLinkTypeLanguagePack =
  InternalLinkTypeLanguagePack
    { language_pack_id = Nothing
    }

defaultInternalLinkTypeMessage :: InternalLinkType
defaultInternalLinkTypeMessage =
  InternalLinkTypeMessage
    { url = Nothing
    }

defaultInternalLinkTypeMessageDraft :: InternalLinkType
defaultInternalLinkTypeMessageDraft =
  InternalLinkTypeMessageDraft
    { text          = Nothing
    , contains_link = Nothing
    }

defaultInternalLinkTypePassportDataRequest :: InternalLinkType
defaultInternalLinkTypePassportDataRequest =
  InternalLinkTypePassportDataRequest
    { bot_user_id  = Nothing
    , scope        = Nothing
...
defaultInternalLinkTypePhoneNumberConfirmation :: InternalLinkType
defaultInternalLinkTypePhoneNumberConfirmation =
  InternalLinkTypePhoneNumberConfirmation
    { hash         = Nothing
...
defaultInternalLinkTypePremiumFeatures :: InternalLinkType
defaultInternalLinkTypePremiumFeatures =
  InternalLinkTypePremiumFeatures
    { referrer = Nothing
    }

defaultInternalLinkTypeProxy :: InternalLinkType
defaultInternalLinkTypeProxy =
  InternalLinkTypeProxy
    { server = Nothing
    , port   = Nothing
...
defaultInternalLinkTypePublicChat :: InternalLinkType
defaultInternalLinkTypePublicChat =
  InternalLinkTypePublicChat
    { chat_username = Nothing
    }

defaultInternalLinkTypeStickerSet :: InternalLinkType
defaultInternalLinkTypeStickerSet =
  InternalLinkTypeStickerSet
    { sticker_set_name    = Nothing
    , expect_custom_emoji = Nothing
    }

defaultInternalLinkTypeStory :: InternalLinkType
defaultInternalLinkTypeStory =
  InternalLinkTypeStory
    { story_sender_username = Nothing
    , story_id              = Nothing
    }

defaultInternalLinkTypeTheme :: InternalLinkType
defaultInternalLinkTypeTheme =
  InternalLinkTypeTheme
    { theme_name = Nothing
    }

defaultInternalLinkTypeUnknownDeepLink :: InternalLinkType
defaultInternalLinkTypeUnknownDeepLink =
  InternalLinkTypeUnknownDeepLink
    { link = Nothing
    }

defaultInternalLinkTypeUserPhoneNumber :: InternalLinkType
defaultInternalLinkTypeUserPhoneNumber =
  InternalLinkTypeUserPhoneNumber
    { phone_number = Nothing
    }

defaultInternalLinkTypeUserToken :: InternalLinkType
defaultInternalLinkTypeUserToken =
  InternalLinkTypeUserToken
    { token = Nothing
    }

defaultInternalLinkTypeVideoChat :: InternalLinkType
defaultInternalLinkTypeVideoChat =
  InternalLinkTypeVideoChat
    { chat_username  = Nothing
    , invite_hash    = Nothing
    , is_live_stream = Nothing
    }

defaultInternalLinkTypeWebApp :: InternalLinkType
defaultInternalLinkTypeWebApp =
  InternalLinkTypeWebApp
    { bot_username       = Nothing
