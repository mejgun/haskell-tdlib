...
data AuctionState
  = AuctionStateActive -- ^ Contains information about an ongoing auction
    ...
    , left_item_count        :: Maybe Int                           -- ^ The number of items that have to be distributed on the auciton
    , acquired_item_count    :: Maybe Int                           -- ^ The number of items that were purchased by the current user on the auciton
