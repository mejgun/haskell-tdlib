...
data MessageContent
  ...
  | MessagePoll -- ^ A message with a poll
    ...
    , _media         :: Maybe MessageContent              -- ^ Media attached to the poll. Currently, can be only of the types messageAnimation, messageAudio, messageDocument, messageLocation, messagePhoto, messageVenue, or messageVideo without caption
