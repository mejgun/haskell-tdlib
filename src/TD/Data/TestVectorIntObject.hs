...
instance AT.ToJSON TestVectorIntObject where
  toJSON TestVectorIntObject
    { value = value_
    }
      = A.object
        [ "@type" A..= AT.String "testVectorIntObject"
        , "value" A..= value_
        ]

defaultTestVectorIntObject :: TestVectorIntObject
defaultTestVectorIntObject =
  TestVectorIntObject
    { value = Nothing
    }
