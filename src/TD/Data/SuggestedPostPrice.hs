...
data SuggestedPostPrice
  = SuggestedPostPriceStar -- ^ Describes price of a suggested post in Telegram Stars
    { star_count :: Maybe Int -- ^ The amount of Telegram Stars expected to be paid for the post; getOption("suggested_post_star_count_min")-getOption("suggested_post_star_count_max")
    }
