...
data ForumTopicInfo
  = ForumTopicInfo -- ^ Contains basic information about a forum topic
    { chat_id          :: Maybe Int                           -- ^ Identifier of a forum supergroup chat or a chat with a bot to which the topic belongs
    ...
    , is_general       :: Maybe Bool                          -- ^ True, if the topic is the General topic
