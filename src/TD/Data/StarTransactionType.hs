...
instance I.ShortShow StarTransactionType where
  ...
  shortShow StarTransactionTypeGiftPurchaseOffer
    { _gift = _gift_
    }
...
instance AT.FromJSON StarTransactionType where
  parseJSON v@(AT.Object obj) = do
    ...
    case t of
      ...
      "starTransactionTypeGiftPurchaseOffer"            -> parseStarTransactionTypeGiftPurchaseOffer v
    ...
    where
      ...
      parseStarTransactionTypeGiftPurchaseOffer :: A.Value -> AT.Parser StarTransactionType
      parseStarTransactionTypeGiftPurchaseOffer = A.withObject "StarTransactionTypeGiftPurchaseOffer" $ \o -> do
        _gift_ <- o A..:?  "gift"
        pure $ StarTransactionTypeGiftPurchaseOffer
          { _gift = _gift_
          }
