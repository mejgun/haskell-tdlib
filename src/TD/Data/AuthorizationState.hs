...
instance AT.ToJSON AuthorizationState where
  toJSON AuthorizationStateWaitTdlibParameters
      = A.object
        [ "@type" A..= AT.String "authorizationStateWaitTdlibParameters"
        ]
  toJSON AuthorizationStateWaitPhoneNumber
      = A.object
        [ "@type" A..= AT.String "authorizationStateWaitPhoneNumber"
        ]
  toJSON AuthorizationStateWaitEmailAddress
    { allow_apple_id  = allow_apple_id_
    , allow_google_id = allow_google_id_
    }
      = A.object
        [ "@type"           A..= AT.String "authorizationStateWaitEmailAddress"
        , "allow_apple_id"  A..= allow_apple_id_
        , "allow_google_id" A..= allow_google_id_
        ]
  toJSON AuthorizationStateWaitEmailCode
    { allow_apple_id            = allow_apple_id_
    , allow_google_id           = allow_google_id_
    , code_info                 = code_info_
    , email_address_reset_state = email_address_reset_state_
      ...
      = A.object
        [ "@type"                     A..= AT.String "authorizationStateWaitEmailCode"
        , "allow_apple_id"            A..= allow_apple_id_
        , "allow_google_id"           A..= allow_google_id_
        , "code_info"                 A..= code_info_
        , "email_address_reset_state" A..= email_address_reset_state_
        ]
  toJSON AuthorizationStateWaitCode
    { _code_info = _code_info_
    }
      = A.object
        [ "@type"     A..= AT.String "authorizationStateWaitCode"
        , "code_info" A..= _code_info_
        ]
  toJSON AuthorizationStateWaitOtherDeviceConfirmation
    { link = link_
    }
      = A.object
        [ "@type" A..= AT.String "authorizationStateWaitOtherDeviceConfirmation"
        , "link"  A..= link_
        ]
  toJSON AuthorizationStateWaitRegistration
    { terms_of_service = terms_of_service_
    }
      = A.object
        [ "@type"            A..= AT.String "authorizationStateWaitRegistration"
        , "terms_of_service" A..= terms_of_service_
        ]
  toJSON AuthorizationStateWaitPassword
    { password_hint                  = password_hint_
    , has_recovery_email_address     = has_recovery_email_address_
    , has_passport_data              = has_passport_data_
    , recovery_email_address_pattern = recovery_email_address_pattern_
      ...
      = A.object
        [ "@type"                          A..= AT.String "authorizationStateWaitPassword"
  ...
  toJSON AuthorizationStateReady
      = A.object
        [ "@type" A..= AT.String "authorizationStateReady"
        ]
  toJSON AuthorizationStateLoggingOut
      = A.object
        [ "@type" A..= AT.String "authorizationStateLoggingOut"
        ]
  toJSON AuthorizationStateClosing
      = A.object
        [ "@type" A..= AT.String "authorizationStateClosing"
        ]
