...
module TD.Reply.GroupCallParticipant where
      ...
      "GroupCallParticipant"
        ++ U.cc
          [ U.p "order" order,
            ...
            U.p "can_unmute_self" can_unmute_self,
            U.p "is_muted_for_current_user" is_muted_for_current_user,
            U.p "is_muted_for_all_users" is_muted_for_all_users,
            U.p "can_be_unmuted_for_current_user" can_be_unmuted_for_current_user,
            U.p "can_be_muted_for_current_user" can_be_muted_for_current_user,
            U.p "can_be_unmuted_for_all_users" can_be_unmuted_for_all_users,
            U.p "can_be_muted_for_all_users" can_be_muted_for_all_users,
            U.p "is_hand_raised" is_hand_raised,
            U.p "is_speaking" is_speaking,
            U.p "is_current_user" is_current_user,
            U.p "bio" bio,
            U.p "screen_sharing_video_info" screen_sharing_video_info,
            U.p "video_info" video_info,
            U.p "screen_sharing_audio_source_id" screen_sharing_audio_source_id,
    ...
    GroupCallParticipant
      ...
      A.object
        [ "@type" A..= T.String "groupCallParticipant",
          ...
          "can_unmute_self" A..= can_unmute_self,
          "is_muted_for_current_user" A..= is_muted_for_current_user,
          "is_muted_for_all_users" A..= is_muted_for_all_users,
          "can_be_unmuted_for_current_user" A..= can_be_unmuted_for_current_user,
          "can_be_muted_for_current_user" A..= can_be_muted_for_current_user,
          "can_be_unmuted_for_all_users" A..= can_be_unmuted_for_all_users,
          "can_be_muted_for_all_users" A..= can_be_muted_for_all_users,
          "is_hand_raised" A..= is_hand_raised,
          "is_speaking" A..= is_speaking,
          "is_current_user" A..= is_current_user,
          "bio" A..= bio,
          "screen_sharing_video_info" A..= screen_sharing_video_info,
          "video_info" A..= video_info,
          "screen_sharing_audio_source_id" A..= screen_sharing_audio_source_id,
