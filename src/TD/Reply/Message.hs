      ...
      "Message"
        ++ U.cc
          [ U.p "reply_markup" reply_markup,
            ...
            U.p "media_album_id" media_album_id,
            U.p "author_signature" author_signature,
            U.p "via_bot_user_id" via_bot_user_id,
            U.p "ttl_expires_in" ttl_expires_in,
            U.p "ttl" ttl,
            U.p "message_thread_id" message_thread_id,
            U.p "reply_to_message_id" reply_to_message_id,
            U.p "reply_in_chat_id" reply_in_chat_id,
            U.p "unread_reactions" unread_reactions,
            U.p "interaction_info" interaction_info,
            U.p "forward_info" forward_info,
            U.p "edit_date" edit_date,
            U.p "date" date,
            U.p "contains_unread_mention" contains_unread_mention,
            U.p "is_channel_post" is_channel_post,
            U.p "has_timestamped_media" has_timestamped_media,
            U.p "can_get_media_timestamp_links" can_get_media_timestamp_links,
            U.p "can_get_viewers" can_get_viewers,
            U.p "can_get_message_thread" can_get_message_thread,
            U.p "can_get_statistics" can_get_statistics,
            U.p "can_get_added_reactions" can_get_added_reactions,
    ...
    Message
      ...
      A.object
        [ "@type" A..= T.String "message",
          ...
          "media_album_id" A..= media_album_id,
          "author_signature" A..= author_signature,
          "via_bot_user_id" A..= via_bot_user_id,
          "ttl_expires_in" A..= ttl_expires_in,
          "ttl" A..= ttl,
          "message_thread_id" A..= message_thread_id,
          "reply_to_message_id" A..= reply_to_message_id,
          "reply_in_chat_id" A..= reply_in_chat_id,
          "unread_reactions" A..= unread_reactions,
          "interaction_info" A..= interaction_info,
          "forward_info" A..= forward_info,
          "edit_date" A..= edit_date,
          "date" A..= date,
          "contains_unread_mention" A..= contains_unread_mention,
          "is_channel_post" A..= is_channel_post,
          "has_timestamped_media" A..= has_timestamped_media,
          "can_get_media_timestamp_links" A..= can_get_media_timestamp_links,
          "can_get_viewers" A..= can_get_viewers,
          "can_get_message_thread" A..= can_get_message_thread,
          "can_get_statistics" A..= can_get_statistics,
          "can_get_added_reactions" A..= can_get_added_reactions,
          "can_be_deleted_for_all_users" A..= can_be_deleted_for_all_users,
          "can_be_deleted_only_for_self" A..= can_be_deleted_only_for_self,
          "can_be_saved" A..= can_be_saved,
          "can_be_forwarded" A..= can_be_forwarded,
          "can_be_edited" A..= can_be_edited,
          "is_pinned" A..= is_pinned,
          "is_outgoing" A..= is_outgoing,
          "scheduling_state" A..= scheduling_state,
          "sending_state" A..= sending_state,
          "chat_id" A..= chat_id,
