...
module TD.Reply.ChatNotificationSettings where

import qualified Data.Aeson as A
import qualified Data.Aeson.Types as T
import qualified Utils as U

data ChatNotificationSettings = -- | Contains information about notification settings for a chat
  ChatNotificationSettings
  { -- |
    disable_mention_notifications :: Maybe Bool,
    -- | If true, disable_mention_notifications is ignored and the value for the relevant type of chat is used instead @disable_mention_notifications If true, notifications for messages with mentions will be created as for an ordinary unread message
    ...
    -- | If true, show_preview is ignored and the value for the relevant type of chat is used instead @show_preview True, if message content must be displayed in notifications
    use_default_show_preview :: Maybe Bool,
    -- |
    sound_id :: Maybe Int,
    -- | If true, the value for the relevant type of chat is used instead of sound_id @sound_id Identifier of the notification sound to be played; 0 if sound is disabled
    use_default_sound :: Maybe Bool,
    -- |
    mute_for :: Maybe Int,
    -- | If true, mute_for is ignored and the value for the relevant type of chat is used instead @mute_for Time left before notifications will be unmuted, in seconds
