...
module TD.Reply.SearchMessagesFilter where
...
instance T.ToJSON SearchMessagesFilter where
  toJSON SearchMessagesFilterEmpty =
    A.object
      [ "@type" A..= T.String "searchMessagesFilterEmpty"
      ]
  toJSON SearchMessagesFilterAnimation =
    A.object
      [ "@type" A..= T.String "searchMessagesFilterAnimation"
      ]
  toJSON SearchMessagesFilterAudio =
    A.object
      [ "@type" A..= T.String "searchMessagesFilterAudio"
      ]
  toJSON SearchMessagesFilterDocument =
    A.object
      [ "@type" A..= T.String "searchMessagesFilterDocument"
      ]
  toJSON SearchMessagesFilterPhoto =
    A.object
      [ "@type" A..= T.String "searchMessagesFilterPhoto"
      ]
  toJSON SearchMessagesFilterVideo =
    A.object
      [ "@type" A..= T.String "searchMessagesFilterVideo"
      ]
  toJSON SearchMessagesFilterVoiceNote =
    A.object
      [ "@type" A..= T.String "searchMessagesFilterVoiceNote"
      ]
  toJSON SearchMessagesFilterPhotoAndVideo =
    A.object
      [ "@type" A..= T.String "searchMessagesFilterPhotoAndVideo"
      ]
  toJSON SearchMessagesFilterUrl =
    A.object
      [ "@type" A..= T.String "searchMessagesFilterUrl"
      ]
  toJSON SearchMessagesFilterChatPhoto =
    A.object
      [ "@type" A..= T.String "searchMessagesFilterChatPhoto"
      ]
  toJSON SearchMessagesFilterVideoNote =
    A.object
      [ "@type" A..= T.String "searchMessagesFilterVideoNote"
      ]
  toJSON SearchMessagesFilterVoiceAndVideoNote =
    A.object
      [ "@type" A..= T.String "searchMessagesFilterVoiceAndVideoNote"
      ]
  toJSON SearchMessagesFilterMention =
    A.object
      [ "@type" A..= T.String "searchMessagesFilterMention"
      ]
  toJSON SearchMessagesFilterUnreadMention =
    A.object
      [ "@type" A..= T.String "searchMessagesFilterUnreadMention"
      ]
  toJSON SearchMessagesFilterUnreadReaction =
    A.object
      [ "@type" A..= T.String "searchMessagesFilterUnreadReaction"
      ]
  toJSON SearchMessagesFilterFailedToSend =
    A.object
      [ "@type" A..= T.String "searchMessagesFilterFailedToSend"
      ]
  toJSON SearchMessagesFilterPinned =
    A.object
      [ "@type" A..= T.String "searchMessagesFilterPinned"
      ]
